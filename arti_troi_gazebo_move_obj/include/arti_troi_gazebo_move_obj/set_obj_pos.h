 ...
 * Date: 29 July 2013
 */
#ifndef GAZEBO_ROS_SET_OBJ_POS_HH
#define GAZEBO_ROS_SET_OBJ_POS_HH
...
namespace gazebo {
  ...
  class GazeboRosSetObjPos : public ModelPlugin {
    ...
    //void pubOdomCallback(const ros::TimerEvent& e);
